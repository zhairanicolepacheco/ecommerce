...
<body>
    ...
    <div class = "login">
        ...
        <div id = "option">
             <h3 id = "signIn">Sign in with your Account </h3>
             <!-- <a href="http://localhost/product-activity/user_register.php"><h3 id = "noAcc"> Create Account</h3></a> -->
        </div>

       
        <form id = "form_container" action="admin-loginprocess.php" method="POST">
            <div class = "container">
                ...
                <div class="button-container">
                    ...
                    <div id = "option">
                        ...
                        <a href="http://localhost/product-activity/user-login.php"><h3 id = "admin"> User</h3></a>
                   </div>
                </div> 
            </div>  
        </form> 
